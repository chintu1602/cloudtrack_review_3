"""
NutriAI Health Portal - Authentication Service
Handles password hashing, JWT token management, and Microsoft Entra ID SSO.
"""
...
def get_msal_app() -> msal.ConfidentialClientApplication:
    """Create an MSAL confidential client application for Entra ID auth."""
...
def get_or_create_entra_user(db: Session, token_result: dict) -> Optional[User]:
    """Get or create a user from Entra ID token claims."""
    try:
